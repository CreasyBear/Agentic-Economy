# Gates: Foundation branch

Scope: Prove child phases integrate as one branch.

- [ ] G1: Every child phase gate is independently met.
  CHECK: node /Users/joelchan/.agents/skills/unlazy/scripts/gate-check.mjs --status gates/phase-0.md gates/phase-1.md gates/phase-2.md
  EXPECT: /ALL MET/
  EVIDENCE: pending

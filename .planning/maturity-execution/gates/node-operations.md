# Gates: Operated platform branch

Scope: Prove child phases integrate as one branch.

- [ ] G1: Every child phase gate is independently met.
  CHECK: node /Users/joelchan/.agents/skills/unlazy/scripts/gate-check.mjs --status gates/phase-5.md gates/phase-6.md gates/phase-7.md gates/phase-8.md
  EXPECT: /ALL MET/
  EVIDENCE: pending

...
Ownership: src/modules/authority/context, src/lib/server/authority-boundary, tests/maturity/leaf-P2-02.test.ts
...
- [ ] G3: The leaf-specific contract test passes.
  CHECK: cd ../.. && npx vitest run tests/maturity/leaf-P2-02.test.ts
  EVIDENCE: pending

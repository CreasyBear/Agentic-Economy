...
- <!-- gate-1 --> **GATE-1 explainer ruling** (founder ruling 2026-07-14): the locked explainer is capability-gated. When a business has a published phone, render **“AE sends your request in writing and keeps a record — or call directly.”** When no phone is published, render **“AE sends your request in writing and keeps a record.”** Surfaces MUST select the variant from the published-phone trust fact and MUST NOT imply a call capability that is absent.

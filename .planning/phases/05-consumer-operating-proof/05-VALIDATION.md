...
| Wave 6 / 05-06 | Zero-instruction Ask cold start, exact insufficiency, answer-first loader/detail/compare, bounded presentation fallback, refresh/share and automated accessibility | T-05-06 | unit/UI/e2e/a11y | `npm exec -- vitest run tests/unit/comparison/presentation.test.ts tests/unit/ui/offering-comparison.test.tsx tests/integration/answer-tool-calls.test.ts tests/unit/answer/answer-tool-use-agent.test.ts && npm exec -- playwright test tests/e2e/cold-start-decision.spec.ts tests/e2e/comparison-surface.spec.ts tests/e2e/a11y/comparison.spec.ts` | ✅ committed source/unit/build plus labelled local-mock browser; no hosted or customer claim |
| Wave 7 / 05-07 | Fixed anonymous POST, actual loader/action parity, inspect-only fence and transfer eval | T-05-07 | integration/import/eval | `npm exec -- vitest run tests/integration/comparison-public-agent-route.test.ts tests/integration/comparison-surface-parity.test.ts tests/imports/comparison-boundaries.test.ts tests/eval/offering-comparison-transfer.test.ts` | ✅ committed source plus focused integration/import and labelled local-fixture transfer; no hosted or customer claim |

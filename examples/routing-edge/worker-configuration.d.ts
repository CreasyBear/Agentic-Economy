/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9763ad7ca00940b30b4df532c45f85cf)
// Runtime types generated with workerd@1.20260708.1 2026-07-12 nodejs_compat
interface __BaseEnv_Env {
	AE_ROUTING_ORIGIN: "https://formal-jaguar-441.convex.site" | "https://loyal-peacock-107.convex.site";
	AE_EDGE_ENVIRONMENT: "production" | "staging";
	AE_EDGE_SOURCE_REVISION: "unbound" | "local";
	AE_EDGE_ORIGIN_HMAC_KEY: string;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		AE_ROUTING_ORIGIN: "https://formal-jaguar-441.convex.site";
		AE_EDGE_ENVIRONMENT: "production";
		AE_EDGE_SOURCE_REVISION: "unbound";
		AE_EDGE_ORIGIN_HMAC_KEY: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AE_ROUTING_ORIGIN" | "AE_EDGE_ENVIRONMENT" | "AE_EDGE_SOURCE_REVISION" | "AE_EDGE_ORIGIN_HMAC_KEY">> {}
}

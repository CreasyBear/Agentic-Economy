...
export function needsClerkPlaceholder(env: Record<string, string | undefined>): boolean
export function anonymousDeploymentEnvSeed(env: Record<string, string | undefined>): string

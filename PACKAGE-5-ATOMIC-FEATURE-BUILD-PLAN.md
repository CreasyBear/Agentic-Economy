...
| Owner onboarding funnel and one UI CTA | [`src/components/ae/supply/AeSupplyLanding.tsx`](./src/components/ae/supply/AeSupplyLanding.tsx), [`src/components/ae/supply/AeSupplyFunnel.tsx`](./src/components/ae/supply/AeSupplyFunnel.tsx) | Keep the user journey; replace inferred/ad hoc status with the shared contract and machine-equivalent start action. |
| Current five-state management summary | [`src/modules/capability-supply/operation-health.ts`](./src/modules/capability-supply/operation-health.ts#L36-L75) | Supersede through an additive adapter, consumer migration and measured removal. |
| Ad hoc owner labels | [`src/components/ae/offerings/owner-operations-projection.ts`](./src/components/ae/offerings/owner-operations-projection.ts) | Delete after every surface consumes the canonical projector. No second label map survives. |

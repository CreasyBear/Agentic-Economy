...
function buildLlmsTxtFromCatalogs(
  ...
  const body = [
    ...
    '- relations=answer_clarification | prepare_options | confirm_option | start_confirmed_option | inspect_progress | inspect_evidence | report_problem | cancel',
    ...
    '5. Show routes_ready options without inferring a choice. Follow confirm_option only after explicit approval; confirmation does not start work.',
    '6. Resume the same Request using advertised relations. Never create a replacement or retry an outcome_unknown effect.',
    '',
    'Catalog entries:',

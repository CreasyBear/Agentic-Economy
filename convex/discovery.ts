...
function buildLlmsTxtFromCatalogs(
  ...
  const body = [
    ...
    '- lifecycle=needs_information | needs_authorization | ready_to_compare | preparing_options | options_ready | no_options | unsupported | needs_attention | outcome_unknown | completed | failed',
    '',
    'Request recipe:',
    ...
    '6. If AE returns a prepared decision, show its customer-facing terms and stop. The customer approves in AE; then resume the same Request. Nothing is booked or purchased by this step.',

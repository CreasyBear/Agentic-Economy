...
function toAuditRow(doc: Doc<'auditEvents'>): SupplyAuditEventRow {
  return {
    eventId: doc.eventId,
    ...(doc.eventType === undefined ? {} : { eventType: doc.eventType }),
    ...(doc.actorKind === undefined ? {} : { actorKind: doc.actorKind }),
    ...(doc.actorRef === undefined ? {} : { actorRef: doc.actorRef }),
    ...(doc.targetType === undefined ? {} : { targetType: doc.targetType }),
    ...(doc.targetRef === undefined ? {} : { targetRef: doc.targetRef }),
    ...(doc.beforeState === undefined ? {} : { beforeState: doc.beforeState }),
    ...(doc.afterState === undefined ? {} : { afterState: doc.afterState }),
    ...(doc.idempotencyKey === undefined ? {} : { idempotencyKey: doc.idempotencyKey }),
    ...
    ...(doc.redactedPayloadJson === undefined ? {} : { redactedPayloadJson: doc.redactedPayloadJson }),
    ...(doc.payloadHash === undefined ? {} : { payloadHash: doc.payloadHash }),

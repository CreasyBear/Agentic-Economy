...
- Final local source acceptance: build, generated output, chat/retained conformance, CLI, managed Operation parity, and the net-deletion target are green through `52d27f7e`. Exact-revision staging and every production/destructive checkpoint remain pending human evidence.

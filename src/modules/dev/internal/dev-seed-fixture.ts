...
const DEV_SEED_INDUSTRIES: readonly DevSeedIndustryTemplate[] = [
  ...
  },
  {
    ...
    pricingSummary: 'Development sample — $140 first hour, then $95 per hour',
    publishesPhone: true,
  },
  {
    slug: 'dental-clinic',
    ...
    pricingSummary: 'Development sample — $95 check-up and clean',
    publishesPhone: true,
  },
  {
    slug: 'family-law',
    ...
    pricingSummary: 'Development sample — $350 first consultation',
    publishesPhone: true,
  },
  {
    slug: 'accounting',
  ...
  },
  {
    ...
    pricingSummary: 'Development sample — $55 per hour, 3 hour minimum',
    publishesPhone: true,
  },
  {
    slug: 'locksmith',

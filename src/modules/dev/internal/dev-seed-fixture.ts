...
const DEV_SEED_ANCHOR_BUSINESSES: readonly DevSeedBusinessFixture[] = [
  ...
  ...[
    ['phase5-web-starter', 'Phase 5 Demo Website Starter', 'Labelled demo website starter', 'Website development'],
    ['phase5-web-growth', 'Phase 5 Demo Website Growth', 'Labelled demo website growth package', 'Website development'],
    ['phase5-data-rest', 'Phase 5 Demo REST Data', 'Labelled demo market data REST feed', 'Machine-readable data'],
    ['phase5-data-graphql', 'Phase 5 Demo GraphQL Data', 'Labelled demo market data GraphQL feed', 'Machine-readable data'],
  ].map(([fixtureKey, businessName, serviceName, category]) => ({
    requestedSlug: `sandbox-${fixtureKey}`,
    businessName: businessName!,
    category: category!,
    suburb: 'Perth',
    stateTerritory: 'WA',
    ownerMessage: 'Clearly labelled non-production business for Phase 5 public comparison verification.',
    sourceLabel: 'AE Phase 5 labelled comparison fixture',
    serviceName: serviceName!,
    serviceCategory: category!,
    serviceSummary: 'Labelled demo facts for public inspect-only comparison. No real service or endpoint is supplied.',
    serviceArea: category === 'Website development' ? 'Perth and remote' : 'Online',
    hoursOrUnknown: 'Demo availability only',
    firstRequestMode: 'not_available_yet' as const,
    publicDisclosure: 'Labelled demo only. Inspection does not contact a business.',
    noContactReason: 'No real service is supplied by this demo fixture.',
  })),
  {

...
export function buildLlmsTxt(
  ...
  const body = [
    ...
    '- lifecycle=needs_information | ready_to_compare | preparing_options | options_ready | unsupported | needs_attention',
    '',
    ...
    '2. If AE asks for information, POST only those facts to /api/v1/requests/:requestRef/facts.',
    '3. POST /api/v1/requests/:requestRef/options to prepare unranked options.',
    '4. GET /api/v1/requests/:requestRef to resume after interruption or waiting.',
    '5. Treat options as proposals only. Nothing has been selected, purchased, or booked.',
    '',
    'Catalog entries:',

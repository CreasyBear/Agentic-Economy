...
export function buildLlmsTxt(
  ...
  const body = [
    ...
    '4. POST /api/v1/requests/:requestRef/options to prepare registered business options.',
    '5. GET /api/v1/requests/:requestRef to resume after interruption or waiting.',
    '6. Read optionSet.ordering: recommended includes its objective, reasons, tradeoffs and influence status; unranked means no defensible ordering. Treat every option as a proposal only. Nothing has been selected, purchased, or booked.',
    '',
    'Catalog entries:',

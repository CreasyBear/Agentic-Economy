...
export function buildLlmsTxt(
  ...
  const body = [
    ...
    '2. Sign the routing request using the descriptor caller-authentication profile.',
    '3. Call route, review the returned quote, then authorize before execution.',
    '4. Inspect or cancel the Root Run using the same caller identity.',
    '',
    'Catalog entries:',

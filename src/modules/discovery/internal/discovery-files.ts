...
export function buildLlmsTxt(
  ...
  const body = [
    ...
    '',
    'Hop recipe:',
    '1. Read /llms.txt (this file) and /SKILL.md.',
    '2. GET /api/agent/tools, then registry.search or registry.detail.',
    '3. Confirm first-contact on the listing before any write.',
    '4. inquiry.submit requires a signed identity; unsigned writes return 403 + Accept-Signature.',
    '5. On success, keep x-ae-authority-receipt headers as the hop receipt.',
    '',
    'Catalog entries:',

export function buildPublicAgentSkillMarkdown(options: { canonicalBaseUrl: string; routingBaseUrl?: string }): string {
  ...
  return [
    ...
    '7. Inspect `options_ready.optionSet.ordering`: `recommended` is tied to the stated objective, reasons, tradeoffs, and commercial-influence evidence; `unranked` means AE found no defensible ordering. Never infer selection or commitment.',
    '',

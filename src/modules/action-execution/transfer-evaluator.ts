...
export type TransferBoundaryEvent =
  ...
  | Readonly<{ kind: 'action_execution'; executionRef: string }>
  | Readonly<{ kind: 'control'; executionRef: string }>
  | Readonly<{ kind: 'attempt'; executionRef: string; attemptRef: string }>
  | Readonly<{ kind: 'history'; executionRef: string; commandId: string }>
  | Readonly<{
  ...
  | Readonly<{ kind: 'authority_decision'; executionRef: string }>
  | Readonly<{ kind: 'user_or_supervisor_decision'; executionRef: string }>
...
function measure(
  ...
  return {
    ...
    logicalTransitions: controlled?.executionVersion

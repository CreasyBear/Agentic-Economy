...
/**
 * Standing-mandate policy decisions retain their v1 canonical bytes. The
 * storage-facing executionRef is projected back to the protected v1
 * invocationRef key only at this existing digest boundary.
 */
export function canonicalPolicyDecisionMaterial(
  decision: Omit<StandingMandatePolicyDecision, 'digest'>,
) {

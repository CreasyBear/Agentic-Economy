...
export const MODULE_BOUNDARY_MANIFEST: ModuleBoundaryManifest = {
  modules: [
    { name: 'common', entrySurfaces: ['action.ts', 'audit-events.ts', 'base64-codec.ts', 'bounded-json.ts', 'canonical-digest.ts', 'convex-literals.ts', 'deep-freeze.ts', 'ed25519-attestation.ts', 'forbidden-signature-key.ts', 'ids.ts', 'is-record.ts', 'json-pointer.ts', 'market-operation-paths.ts', 'matching-csrf.ts', 'normalize-search-text.ts', 'normalize-slug.ts', 'operation-ref.ts', 'random-id.ts', 'runtime-id.ts', 'same-string-list.ts', 'sanitize-text.ts', 'stable-hash.ts', 'trim-trailing-slashes.ts', 'unique-sorted.ts'], allowedDependencies: [] },
  ...
  testOnlyWhiteBoxExceptions: [
    ...
    { id: 'test-whitebox-61', importers: ['tests/unit/server/mcp-api-operation-recovery.test.ts'], to: 'action-execution', entry: 'reconciliation-evidence.ts', owner: 'source-tests' },

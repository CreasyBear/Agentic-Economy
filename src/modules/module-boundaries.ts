...
export const MODULE_BOUNDARY_MANIFEST: ModuleBoundaryManifest = {
  ...
  testOnlyWhiteBoxExceptions: [
    ...
    { id: 'test-whitebox-05', importers: ['tests/helpers/discovered-tool-fixture.ts', 'tests/integration/facilitator-discovery.test.ts', 'tests/integration/x402-directory-resolution.test.ts', 'tests/unit/capability-supply/facilitator-discovery-ingest.test.ts', 'tests/unit/capability-supply/publication-importers-x402.test.ts', 'tests/unit/capability-supply/readiness-probe-x402.test.ts', 'tests/unit/capability-supply/x402-committed-request.test.ts'], to: 'capability-supply', entry: 'internal/x402-bazaar-fixtures/timezone-payment-required-2026-08-19.json', owner: 'source-tests' },

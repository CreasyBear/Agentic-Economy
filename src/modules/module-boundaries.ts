...
export const MODULE_BOUNDARY_MANIFEST: ModuleBoundaryManifest = {
  modules: [
    ...
    { name: 'security', entrySurfaces: ['public.ts', 'schema.ts', 'source-write-admission.ts', 'admin-readback.functions.ts', 'removal-dispute.functions.ts', 'account-security.ts', 'account-security.functions.ts'], allowedDependencies: ['common', 'business', 'capability-contract'] },
    ...
    { name: 'capability-execution', entrySurfaces: ['index.ts', 'schema.ts', 'convex.ts', 'current-tool-quote.ts', 'call-receipt-view.ts', 'call-runtime.ts', 'provider-consequence-runtime.ts', 'live-x402-requirement.ts', 'call-approval.functions.ts', 'quote.ts', 'quote.actions.ts', 'call-history.actions.ts', 'call-entry.ts', 'call-contracts.ts', 'call.actions.ts', 'call-authority.ts', 'call-recovery-contracts.ts', 'call-recovery.actions.ts', 'call-recovery.functions.ts'], allowedDependencies: ['common', 'network-guard', 'capability-contract', 'business', 'security', 'agent-access', 'money', 'observability', 'action-execution', 'capability-supply', 'principal-account', 'secrets'] },
    { name: 'registry', entrySurfaces: ['public.ts', 'schema.ts', 'tool-entry.ts', 'tool-paths.ts', 'tool-action-contracts.ts', 'tool-choice-contracts.ts', 'registry.actions.ts', 'tools.actions.ts', 'registry.functions.ts', 'tool-detail-route.functions.ts'], allowedDependencies: ['common', 'capability-contract', 'business', 'catalog', 'capability-supply', 'money', 'observability'] },
    { name: 'market', entrySurfaces: ['server.ts', 'schema.ts', 'contracts.ts', 'agentic-market-source.ts', 'allocation-evidence.ts', 'home-catalogue.ts', 'listing-evidence.ts', 'market.functions.ts', 'tool-view-model.ts', 'registry-graduation.ts', 'registry-launch-cohort.ts', 'registry-source-adapters.ts', 'registry-source-contracts.ts', 'suggested-next-action.ts', 'x402-directory.ts', 'x402-directory.functions.ts', 'x402-directory.server.ts', 'x402-directory-catalogue.ts', 'x402-directory-index.ts', 'x402-directory-index.functions.ts', 'x402-directory-index.server.ts', 'x402-directory-metadata.ts', 'x402-directory-navigation.ts', 'x402-directory-title.ts', 'x402-marketplace-home.ts', 'x402-marketplace-home.functions.ts', 'x402-marketplace-home.server.ts'], allowedDependencies: ['common', 'capability-contract', 'business', 'capability-supply', 'money', 'observability'] },
  ...
  testOnlyWhiteBoxExceptions: [
    { id: 'test-whitebox-01', importers: ['tests/eval/adr009-composition-direct-control.test.ts', 'tests/eval/support/adr009-transfer-comparison.ts'], to: 'action-execution', entry: 'transfer-evaluator.ts', owner: 'source-tests' },
    { id: 'test-whitebox-02', importers: ['tests/helpers/x402-payment-attempt.ts'], to: 'action-execution', entry: 'x402-payment-attempt.ts', owner: 'source-tests' },
    { id: 'test-whitebox-03', importers: ['tests/integration/capability-call-workpool.test.ts'], to: 'capability-supply', entry: 'internal/graph/qualify-candidate.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-05', importers: ['tests/helpers/discovered-tool-fixture.ts', 'tests/integration/facilitator-discovery.test.ts', 'tests/integration/market-graduation-authority.test.ts', 'tests/integration/x402-directory-resolution.test.ts', 'tests/unit/capability-supply/facilitator-discovery-ingest.test.ts', 'tests/unit/capability-supply/publication-importers-x402.test.ts', 'tests/unit/capability-supply/readiness-probe-x402.test.ts', 'tests/unit/capability-supply/x402-committed-request.test.ts', 'tests/unit/market/registry-graduation.test.ts'], to: 'capability-supply', entry: 'internal/x402-bazaar-fixtures/timezone-payment-required-2026-08-19.json', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-08', importers: ['tests/unit/action-execution/durable-action-execution-cancel.test.ts', 'tests/unit/action-execution/durable-action-execution-harness.ts', 'tests/unit/action-execution/durable-action-execution-lease.test.ts', 'tests/unit/action-execution/durable-action-execution-observation.test.ts', 'tests/unit/action-execution/durable-action-execution-release.test.ts', 'tests/unit/action-execution/durable-action-execution-result.test.ts', 'tests/unit/action-execution/durable-action-execution-transact.test.ts', 'tests/unit/action-execution/unrestricted-test-only.test.ts', 'tests/unit/action-execution/in-memory-action-execution.test.ts', 'tests/unit/action-execution/neutral-contract-boundary.test.ts', 'tests/unit/action-execution/execution-public.test.ts', 'tests/unit/action-execution/spending-policy.test.ts', 'tests/unit/capability-supply/supplied-candidate-quote-authority.test.ts', 'tests/unit/capability-supply/supplied-candidate-quote-harness.ts', 'tests/unit/capability-supply/supplied-candidate-quote-outcomes.test.ts', 'tests/unit/capability-supply/supplied-candidate-quote-reconciliation.test.ts', 'tests/unit/capability-supply/supplied-candidate-quote-transfer.test.ts'], to: 'action-execution', entry: 'index.ts', owner: 'source-tests' },
    { id: 'test-whitebox-10', importers: ['tests/unit/action-execution/execution-public.test.ts'], to: 'action-execution', entry: 'internal/durable-contracts.ts', owner: 'source-tests' },
    { id: 'test-whitebox-12', importers: ['tests/unit/capability-execution/call-receipt-contract.test.ts'], to: 'capability-execution', entry: 'call-worker/brokeredX402.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-19', importers: ['tests/unit/capability-supply/facilitator-discovery-ingest.test.ts', 'tests/unit/capability-supply/x402-request.test.ts', 'tests/unit/capability-supply/x402-seller-endpoint-inspector.test.ts'], to: 'capability-supply', entry: 'internal/x402-bazaar-fixtures/synthetic-post-payment-required.json', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-21', importers: ['tests/unit/capability-supply/facilitator-discovery-ingest.test.ts', 'tests/unit/capability-supply/x402-request.test.ts'], to: 'capability-supply', entry: 'internal/publication-importer-x402-bazaar.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-23', importers: ['tests/unit/capability-supply/tool-ledger.test.ts', 'tests/unit/capability-supply/publication-commands-publish.test.ts', 'tests/unit/capability-supply/publication-commands-republish.test.ts'], to: 'capability-supply', entry: 'internal/tool-ledger/index.ts', owner: 'source-tests' },
    { id: 'test-whitebox-24', importers: ['tests/unit/capability-supply/tool-ledger.test.ts'], to: 'capability-supply', entry: 'internal/shared/index.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-47', importers: ['tests/unit/convex/x402-route-authorization.test.ts', 'tests/unit/convex/x402-route-rpc-consensus.test.ts'], to: 'capability-execution', entry: 'call-worker/x402Route.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-63', importers: ['tests/unit/capability-supply/supply-source-preview.test.ts'], to: 'capability-supply', entry: 'internal/mcp-source-discovery.ts', owner: 'source-tests' },
    { id: 'test-whitebox-64', importers: ['tests/unit/capability-supply/supply-source-preview.test.ts'], to: 'capability-supply', entry: 'internal/source-route-identity.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-61', importers: ['tests/unit/server/mcp-api-call-recovery.test.ts'], to: 'action-execution', entry: 'reconciliation-evidence.ts', owner: 'source-tests' },
    { id: 'test-whitebox-62', importers: ['tests/unit/capability-execution/provider-consequence-bridge.test.ts'], to: 'capability-execution', entry: 'call-worker/providerConsequenceBridge.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-74', importers: ['tests/unit/convex/capability-call-identity.test.ts'], to: 'capability-execution', entry: 'call-admit.ts', owner: 'source-tests' },
    { id: 'test-whitebox-75', importers: ['tests/unit/capability-supply/tool-public-schema.test.ts'], to: 'capability-supply', entry: 'internal/tool-projection-wire-schema.ts', owner: 'source-tests' },

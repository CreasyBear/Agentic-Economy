...
export const MODULE_BOUNDARY_MANIFEST: ModuleBoundaryManifest = {
  modules: [
    ...
    { name: 'agent-access', entrySurfaces: ['public.ts', 'schema.ts', 'contract.ts', 'account.actions.ts', 'issued-agent-binding.ts', 'agent-access.ts', 'agent-access.functions.ts', 'policy.ts', 'policy.functions.ts', 'production-policy.ts', 'sandbox-policy.ts', 'service-auth-envelope.ts', 'agent-access-console.ts', 'agent-operator-view-model.ts', 'consent-read-model.ts', 'oauth-state.ts'], allowedDependencies: ['common', 'capability-contract', 'security', 'money', 'principal-account'] },
    { name: 'money', entrySurfaces: ['public.ts', 'schema.ts', 'server.ts', 'money.functions.ts', 'formance.ts', 'formance-workflows.ts', 'funding-handoff.actions.ts'], allowedDependencies: ['common', 'security'] },
    ...
    { name: 'market', entrySurfaces: ['server.ts', 'schema.ts', 'contracts.ts', 'agentic-market-source.ts', 'allocation-evidence.ts', 'home-catalogue.ts', 'listing-evidence.ts', 'market.functions.ts', 'tool-view-model.ts', 'registry-graduation.ts', 'registry-launch-cohort.ts', 'registry-source-adapters.ts', 'registry-source-contracts.ts', 'suggested-next-action.ts'], allowedDependencies: ['common', 'capability-contract', 'business', 'capability-supply', 'money', 'observability'] },
  ...
  testOnlyWhiteBoxExceptions: [
    ...
    { id: 'test-whitebox-19', importers: ['tests/unit/capability-supply/facilitator-discovery-ingest.test.ts', 'tests/unit/capability-supply/x402-seller-endpoint-inspector.test.ts'], to: 'capability-supply', entry: 'internal/x402-bazaar-fixtures/synthetic-post-payment-required.json', owner: 'source-tests' },

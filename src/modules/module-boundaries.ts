...
export const MODULE_BOUNDARY_MANIFEST: ModuleBoundaryManifest = {
  modules: [
    ...
    { name: 'observability', entrySurfaces: ['public.ts', 'schema.ts', 'funnel.functions.ts', 'stored-compatibility.ts', 'stored-business-action-compatibility.ts'], allowedDependencies: ['common', 'business'] },
    ...
    { name: 'market', entrySurfaces: ['server.ts', 'schema.ts', 'contracts.ts', 'agentic-market-source.ts', 'allocation-evidence.ts', 'home-catalogue.ts', 'listing-evidence.ts', 'market.functions.ts', 'operation-view-model.ts', 'project-query-compatibility.ts', 'registry-graduation.ts', 'registry-source-adapters.ts', 'registry-source-contracts.ts'], allowedDependencies: ['common', 'capability-contract', 'business', 'capability-supply', 'money', 'observability'] },
    ...
    { name: 'chat', entrySurfaces: ['share-token.ts', 'schema.ts'], allowedDependencies: ['common', 'actions', 'registry', 'capability-execution'] },

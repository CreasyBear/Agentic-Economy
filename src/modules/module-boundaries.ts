...
export const MODULE_BOUNDARY_MANIFEST: ModuleBoundaryManifest = {
  modules: [
    ...
    { name: 'agent-access', entrySurfaces: ['public.ts', 'schema.ts', 'contract.ts', 'account.actions.ts', 'issued-agent-binding.ts', 'agent-access.ts', 'agent-access.functions.ts', 'policy.ts', 'policy.functions.ts', 'production-policy.ts', 'sandbox-policy.ts', 'service-auth-envelope.ts', 'agent-access-console.ts', 'agent-operator-view-model.ts', 'oauth-state.ts'], allowedDependencies: ['common', 'capability-contract', 'security', 'money', 'principal-account'] },
    { name: 'money', entrySurfaces: ['public.ts', 'schema.ts', 'server.ts', 'money.functions.ts', 'formance.ts', 'formance-workflows.ts'], allowedDependencies: ['common', 'security'] },
  ...
  testOnlyWhiteBoxExceptions: [
    ...
    { id: 'test-whitebox-45', importers: ['tests/unit/convex/capability-operation-worker-pre-submission-recover.test.ts', 'tests/unit/convex/capability-operation-worker-recover.test.ts'], to: 'capability-execution', entry: 'invocation-worker/recover.ts', owner: 'source-tests' },
    { id: 'test-whitebox-46', importers: ['tests/unit/convex/capability-operation-worker-pre-submission-recover.test.ts', 'tests/unit/convex/capability-operation-worker-recover.test.ts'], to: 'capability-execution', entry: 'invocation-worker/x402Settlement.ts', owner: 'source-tests' },
    ...
    { id: 'test-whitebox-67', importers: ['tests/unit/convex/capability-operation-worker-recover.test.ts'], to: 'capability-execution', entry: 'invocation-worker/recovery/x402.ts', owner: 'source-tests' },

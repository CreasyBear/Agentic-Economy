...
export const workTreeTables = {
  ...
  workTreeRepeatPermissions: defineTable({
    ...
    perUseSpendUnits: v.string(),
    perUseSpendExponent: v.number(),
    cumulativeSpendCurrency: v.string(),
    cumulativeSpendUnits: v.string(),
    cumulativeSpendExponent: v.number(),
    ...
    reservedSpendCurrency: v.string(),
    reservedSpendUnits: v.string(),
    reservedSpendExponent: v.number(),
    settledSpendCurrency: v.string(),
    settledSpendUnits: v.string(),
    settledSpendExponent: v.number(),
  ...
  workTreeRepeatUses: defineTable({
    ...
    requestedSpendUnits: v.string(),
    requestedSpendExponent: v.number(),
    ...
    actualSpendUnits: v.optional(v.string()),
    actualSpendExponent: v.optional(v.number()),
    actualDataAllocations: v.optional(v.number()),
    releasedOccurrences: v.number(),
    releasedSpendCurrency: v.string(),
    releasedSpendUnits: v.string(),
    releasedSpendExponent: v.number(),
    ...
    finalizeReleasedSpendCurrency: v.union(v.string(), v.null()),
    finalizeReleasedSpendUnits: v.union(v.string(), v.null()),
    finalizeReleasedSpendExponent: v.union(v.number(), v.null()),
    finalizeReleasedDataAllocations: v.union(v.number(), v.null()),
    finalizeHeldSpendCurrency: v.union(v.string(), v.null()),
    finalizeHeldSpendUnits: v.union(v.string(), v.null()),
    finalizeHeldSpendExponent: v.union(v.number(), v.null()),
  ...
  workTreeApprovals: defineTable({
    ...
    authorityAmountUnits: v.optional(v.string()),
    authorityAmountExponent: v.optional(v.number()),
    expectedGeneration: v.number(),
    expectedRevision: v.number(),
    issuedAt: v.number(),
    expiresAt: v.number(),

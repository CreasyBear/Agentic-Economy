...
} from '@/routes/_operator/admin.business-actions'

export const Route = createFileRoute('/_operator/admin/business-actions/$requestId')({
...
function AdminBusinessActionDetailRoute() {
  ...
  const detailPath = `/admin/business-actions/${params.requestId}`

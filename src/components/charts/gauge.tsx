...
export interface GaugeProps {
  ...
  orientation?: (GaugeOrientation) | undefined;
  /** Fill level 0–100 */
  value: number;
  /** Number of notches */
  totalNotches?: (number) | undefined;
  /** Percentage of the track reserved for gaps between notches */
  spacing?: (number) | undefined;
  notchCornerRadius?: (number) | undefined;
  /** `true` = rectangular notches; `false` = tapered toward center / midline */
  uniformWidth?: (boolean) | undefined;
  startAngle?: (number) | undefined;
  endAngle?: (number) | undefined;
  useGradient?: (boolean) | undefined;
  activeGradient?: (readonly [string, string]) | undefined;
  inactiveGradient?: (readonly [string, string]) | undefined;
  ...
  labelPlacement?: (GaugeLabelPlacement) | undefined;
  /** Cross-axis alignment (start / center / end), same model as chart legend */
  labelAlign?: (GaugeLabelAlign) | undefined;
  inactiveFill?: (string) | undefined;
  activeFill?: (string) | undefined;
  inactiveFillOpacity?: (number) | undefined;
  activeFillOpacity?: (number) | undefined;
  children?: (ReactNode) | undefined;
  className?: (string) | undefined;
  width?: (number) | undefined;
  height?: (number) | undefined;
  minWidth?: (number) | undefined;
  notchLengthPercent?: (number) | undefined;
  /** Linear only — notch width as % of each slot (default 80) */
  notchWidthPercent?: (number) | undefined;
  /** Linear only — bar thickness in px when responsive (default 24) */
  linearHeight?: (number) | undefined;
  enterTransition?: (Transition) | undefined;
  enterStaggerScale?: (number) | undefined;
  /** Studio-only: static paths while scrubbing geometry controls */
  geometryScrubbing?: (boolean) | undefined;
}

  ...
  return (
    <section className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-12 md:px-6 md:py-16">
      <div className="flex max-w-3xl flex-col gap-4">
        ...
        <h1 className="text-balance font-heading text-4xl font-semibold leading-tight tracking-normal text-foreground md:text-5xl">
          {title}
        </h1>
        <p className="max-w-2xl text-pretty text-base leading-7 text-muted-foreground">{description}</p>
      </div>

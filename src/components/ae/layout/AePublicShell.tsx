  ...
  return (
    <Link href="/" aria-label="Agentic Economy home" className="flex items-center gap-3 no-underline">
      ...
      <span className="hidden min-w-0 flex-col sm:flex">
        ...
        <Text type="supporting" color="secondary">Proof-ledger handoffs for agentic commerce.</Text>
      </span>
    </Link>
  )
}
...
function PublicFooter({ immersive }: { immersive: boolean }) {
  return (
    <footer className="border-t border-border bg-surface">
      ...
      >
        {immersive ? null : <span>Published facts, dated source notes, and inquiry receipts. AE does not book, charge, or dispatch.</span>}

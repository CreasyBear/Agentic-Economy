...
| Backups/disaster recovery | `VERIFIED` | Completed Sydney backup and Melbourne copy; isolated PITR restored the current environment and Formance verified schema, transaction and balance digests plus idempotent replay. | Repeat within the strict five-minute RPO; current result was 5m08s. |

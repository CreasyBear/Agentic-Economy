...
| Well 0 — hosted cutover | Dev cutover complete; hosted deploy pending (Joel's call, production deploy from unpushed local main). Follow the runbook. | [Well 0 closeout, Hosted cutover runbook](docs/workflow/well-0-standalone-closeout.md#hosted-cutover-runbook). |

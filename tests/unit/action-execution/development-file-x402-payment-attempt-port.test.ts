...
import { createDevelopmentFileX402PaymentAttemptPort } from '../../../tools/dev/fixtures/action-execution/development-file-x402-payment-attempt-port'
  ...
  it('refuses raw custody material before it reaches the file', () => {
    ...
    expect(() => port.persist({
      ...
      attempt: {
        ...
        executionRef: authorizationEvent.executionRef,

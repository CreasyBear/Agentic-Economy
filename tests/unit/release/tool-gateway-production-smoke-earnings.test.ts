import "./tool-gateway-production-smoke-harness";
import { describe, expect, it } from "vitest";

import { parseGatewayOwnerProviderEarnings } from "../../../tools/release/tool-gateway-production-smoke";

describe("hosted Tool gateway smoke earnings", () => {
  it("rejects mixed-currency Provider earnings readback", () => {
    ...
    ).toThrow("gateway_smoke_provider_earnings_currency_mismatch");
  });
  it("parses authoritative earnings and refuses truncation", () => {
    ...
    ).toThrow("gateway_smoke_provider_earnings_truncated");
  });
});

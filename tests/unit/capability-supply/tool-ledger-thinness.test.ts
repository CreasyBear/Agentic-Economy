...
const moduleRoot = 'src/modules/capability-supply/internal/tool-ledger'
...
describe('capability-supply tool-ledger thinness', () => {
  ...
  it('keeps thin (db, command, now) command re-exports via portsFor', () => {
    ...
    expect(convexSupply).toContain('capabilitySupplyToolPorts')
  ...
  it('keeps tool-ledger free of Convex runtime imports', () => {

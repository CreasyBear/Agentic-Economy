...
import { AeProviderToolDetail } from '@/components/ae/supply/AeProviderToolDetail'
...
} as const satisfies ProviderToolStatus
...
it('shows one factual Published status and the existing withdraw correction without manual admission ceremonies', async () => {
  ...
  render(<AeProviderToolDetail name="Reference lookup" status={status} onWithdraw={withdraw} />)

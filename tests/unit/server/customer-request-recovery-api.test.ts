...
import type { CustomerRequestEvidenceExport, CustomerRequestProblemReceipt } from '@/modules/customer-request/agent-contract'
...
) => Promise<CustomerRequestProblemReceipt | CustomerRequestEvidenceExport>) {

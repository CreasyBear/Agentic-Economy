...
const requiredIndexes = {
  ...
  routingKernelAdmissionMeters: ['by_meterKey_and_admittedAt'],
  routingKernelAdmissionLeases: ['by_requestId', 'by_status_and_expiresAt', 'by_agentId_and_status_and_expiresAt'],
  routingKernelAdmissionDecisions: ['by_requestId', 'by_disposition_and_decidedAt'],

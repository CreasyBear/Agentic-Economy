...
const requiredIndexes = {
  ...
  moneyLedgerEntries: ['by_transactionRef', 'by_accountRef_and_createdAt', 'by_principalId_and_createdAt', 'by_businessId_and_createdAt'],
  moneyTransactions: ['by_idempotencyKey', 'by_transactionRef', 'by_principalId_and_createdAt', 'by_externalRef'],
  moneyUsageEvents: ['by_principalId_and_observedAt', 'by_principalId_and_credentialId_and_observedAt', 'by_businessId_and_observedAt', 'by_invocationRef'],
  ...
  moneyPayouts: ['by_businessId_and_currency_and_state', 'by_periodStart_and_state', 'by_stripeTransferId'],
  ...
  legacyOfferingCrosswalks: ['by_serviceId', 'by_businessId_and_offeringRef'],
  catalogSupplyCutovers: ['by_businessId'],
  catalogProjectionChecks: ['by_checkRef', 'by_businessId_and_observedAt'],

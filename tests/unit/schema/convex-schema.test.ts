...
const durableTables = [
  ...
  'offeringAccessPaths',
  'legacyOfferingCrosswalks',
  'catalogSupplyCutovers',
  'catalogProjectionChecks',
  ...
  'hostedPaidOperationHeaders',
  'hostedPaidOperationSources',
  'hostedPaidOperationPayments',
  'hostedPaidOperationEvidenceReferences',
  'hostedPaidOperationCommands',
  'hostedPaidOperationMockEffects',
  'hostedPaidOperationAdmissionPolicies',
  'hostedPaidOperationAdmissionCounters',
  'hostedPaidOperationAdmissionReservations',
  'hostedPaidOperationDeploymentReceipts',
...
const requiredIndexes = {
  ...
  hostedPaidOperationHeaders: [
    'by_ownerPrincipalRef_and_invocationRef',
    'by_invocationRef',
  ],
  hostedPaidOperationSources: ['by_invocationRef_and_sourceRef'],
  hostedPaidOperationPayments: [
    'by_invocationRef_and_paymentIdentifier',
    'by_invocationRef_and_attemptRef_and_effectGeneration',
  ],
  hostedPaidOperationEvidenceReferences: [
    'by_invocationRef_and_attemptRef_and_effectGeneration',
  ],
  hostedPaidOperationCommands: [
    'by_invocationRef_and_commandId',
    'by_commandId',
  ],
  hostedPaidOperationMockEffects: [
    'by_invocationRef_and_attemptRef_and_effectGeneration',
  ...
  hostedPaidOperationAdmissionPolicies: [
    'by_policyRef',
    'by_policyRef_and_principalRef',
  ],
  hostedPaidOperationAdmissionCounters: ['by_policyRef_and_principalRef'],
  hostedPaidOperationAdmissionReservations: [
    'by_reservationRef',
    'by_policyRef_and_principalRef_and_reservationRef',
  ],
  hostedPaidOperationDeploymentReceipts: ['by_receiptRef'],

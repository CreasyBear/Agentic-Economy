...
describe('answer run summary', () => {
  it('summarizes complete, error, refused, timings, evidence, and coverage', () => {
    ...
    expect(report.coverage).toEqual({
      toolsAvailable: ['registry.search', 'registry.detail', 'web.discover', 'registry.operations.search'],
      toolsInvoked: ['registry.detail', 'registry.search'],
      toolsUnused: ['web.discover', 'registry.operations.search'],
    ...
    expect(harnessReport.coverage.toolsUnused).toEqual(['registry.operations.search', 'web.discover'])
  ...
  it('produces a stable empty summary for failed turns with no evidence', () => {
    ...
    expect(report.coverage.toolsUnused).toEqual(['registry.search', 'registry.detail', 'web.discover', 'registry.operations.search'])
    expect(buildPublicAnswerCheckSummary(report)).toEqual({
      catalogSearches: 0,
      listingsRead: 0,
      listedBusinesses: 0,
    ...
    expect(harnessReport.coverage.toolsUnused).toEqual(['registry.detail', 'registry.operations.search', 'registry.search', 'web.discover'])
  })
})

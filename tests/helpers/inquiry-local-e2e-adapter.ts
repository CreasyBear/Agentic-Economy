...
import { LOCAL_E2E_BUSINESS_FIXTURES, type LocalE2eBusinessFixture, type LocalE2eOfferingFixture } from './local-e2e-business-fixtures'
...
} from '@/modules/inquiries/internal/submitted-receipt'
...
function localE2eBusiness(): BusinessRecord {
  return {
    ...
    businessContext: {
      ...
      ...(localE2eBusinessFixture.publishedPhone === undefined ? {} : { publishedPhone: localE2eBusinessFixture.publishedPhone }),
    },

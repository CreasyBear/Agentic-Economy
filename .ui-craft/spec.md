...
- Composition: query box → generative answer. Daylight Register visuals, Google-Maps-clean provider cards, hand-drawn hero.
...
- Spec pending — Daylight Register refactor pass.
...
- Visuals: `DESIGN.md` (Daylight Register, §10–§17). Principles: `.ui-craft/brief.md`.
